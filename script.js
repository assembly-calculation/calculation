...
var errorForm = document.getElementById('form-main-error');
...
function togglePopupState(state) {
  switch(state) {
    ...
    case 'close': {
     popup.classList.remove('animated', 'slideInUp');
      break;
    }
    default: break;
  }
